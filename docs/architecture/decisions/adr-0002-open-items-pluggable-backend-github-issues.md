...
| OI-0029 | execution-item | Build one-way `markdown → github` migration emitting an `OI-NNNN → #N` map | #data-model--interoperability | Data model & interoperability | Add a migration mode/script | medium | open | victor | 2026-07-01 | _TBD_ |
