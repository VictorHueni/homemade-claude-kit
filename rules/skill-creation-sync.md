...
| `design-` | `docs/design/` (project visual source of truth — tokens consumed by the `com-` presentation layer; cross-cutting, mints no IDs) | `design-system` (→ `docs/design/design-system.md` + `tokens.css`) |
