...
|---|---|---|
| Customer Segments | Personas | `[P-NN persona-name](../personas/personas.md#p-nn)` |
| Value Propositions | Value streams + VPCs | `[VS-N stream-name](../value-streams/value-streams.md#vs-n)` + `[VPC for CS-1](value-proposition-canvas-cs-1.md)` |
| Channels | Value-stream stages | `[VS-N.M stage-name](../value-streams/value-streams.md#vs-nm)` |
...
| Key Resources *(BMC)* | Capabilities | `[C-N.M capability-name](../capability-map/capability-map.md#c-nm)` |
...
| Problem *(Lean)* | Persona pains + VPC | `[Persona pain](../personas/personas.md#p-nn) + [VPC pain](value-proposition-canvas-cs-1.md#pains)` |
| Solution *(Lean)* | FBS functionalities | `[FBS C1.1.F01](../../product-specs/functional-breakdown-structure/FBS.md#c11f01)` |
| Key Metrics *(Lean)* | Quantitative models | `[Metrics model](../models/...)` |
| Unfair Advantage *(Lean)* | Differentiator-rated capabilities | `[C-N.M (Differentiator)](../capability-map/capability-map.md#c-nm)` |
