...
**Output:** ONE file in `docs/business/research/`:
...
2. **Create** `interview-{persona-id-or-slug}-{topic}.md` in `docs/business/research/`.
...
2. **Create** `research-synthesis-{date}-{topic}.md` in `docs/business/research/`.
3. **Fill the template:**
...
**Process:**
1. **Create** `research-plan-{topic}.md` in `docs/business/research/`.
2. **Fill the template:**
...
|---|---|
| Interview script for P-NN | `docs/business/personas/personas.md#p-nn` — listed as hypothesis target |
| Synthesis (BMC validation) | `docs/business/business-model-canvas/business-model-canvas.md` blocks — confidence ratings updated |
...
| Synthesis (persona refinement) | `docs/business/personas/personas.md` — proto → research-grounded transition; specific fields updated |
...
- `docs/business/interviews/` — narrower naming
- `docs/research/` — when research has its own root
