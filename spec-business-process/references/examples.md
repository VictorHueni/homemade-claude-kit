...
`docs/business/processes/swiss-kostengutsprache-process.md` in the swiss-aos-drug-reimbursement-model project is the operator-grade implementation of this pattern.
