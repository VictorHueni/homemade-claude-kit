...
| §17 Frontmatter validity | `rules/artefact-frontmatter.md` — canonical five-field schema + conditional supersession fields; staleness depends on `last_reviewed` + `review_interval` |
